...
class SignupNonMahePage extends StatefulWidget {
  SignupNonMahePage({super.key});

  @override
  State<SignupNonMahePage> createState() => _RegisterPageState2();
}

class _RegisterPageState2 extends State<SignupNonMahePage> {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            Text(
                                "Register with your email address",  //Different from Signup MAHE
                      ...
                      InputTextField(
                          ...
                          hintText: "Email",  //Different from Signup MAHE
                          obscureText: false
                      ),
                              ...
                              GestureDetector(
                                  ...
                                  child: const Text(
                                    // TODO: WRAP THIS IN A BUTTON (Gesture detection) TO HANDLE TRANSITION TO "AFFILIATION" PAGE
                                      "Sign in",
                                      style: TextStyle(color: Color(0xff000000), fontFamily: 'Roboto-Bold')
                                  )// Register Text
                              )
